...
/** Beceri adındaki anahtar kelimeye göre emoji seçimi */
const EMOJI_KEYWORDS: Array<[string[], string]> = [
  [["ampul", "avize", "spot", "led", "aydınlatma", "aplik"], "💡"],
  [["priz", "anahtar", "sigorta", "elektrik", "kablo", "jeneratör", "kombi elektrik"], "⚡"],
  [["zil", "diyafon"], "🔔"],
  [["ısıtıcı"], "🔥"],
  [["musluk", "batarya"], "🚰"],
  [["sifon", "klozet"], "🚽"],
  ...
  [["boya", "badana", "astar"], "🎨"],
  [["duvar kağıdı"], "🧻"],
  [["ahşap", "vernik", "marangoz"], "🪵"],
  [["radyatör"], "♨️"],
  [["kartonpiyer", "kalıp", "bordür"], "📏"],
  [["iç mimari"], "📐"],
  [["uydu", "çanak", "anten"], "📡"],
  [["modem", "internet", "wi-fi", "wifi"], "📶"],
  [["bilgisayar", "pc"], "💻"],
  [["yazıcı"], "🖨️"],
  [["telefon", "tablet"], "📱"],
  [["akıllı ev", "akıllı cihaz"], "🏠"],
  [["kamera"], "📷"],
  [["alarm"], "🚨"],
  [["küçük ev aleti"], "🔌"],
  [["nakliyat", "taşıma", "taşıma yardımı"], "📦"],
  [["ofis taşıma"], "🏢"],
  [["paketleme", "paket"], "📦"],
  [["kurye"], "🛵"],
  [["kamyonet"], "🚚"],
  ...
  [["çit", "tel örgü"], "🚧"],
  [["kamelya", "pergola"], "⛺"],
  [["bitki", "saksı", "balkon", "çiçek"], "🪴"],
  [["havuz"], "🏊"],
  [["kar temizleme"], "❄️"],
  [["barbekü"], "🍖"],
  [["lastik"], "🛞"],
  [["akü"], "🔋"],
  [["araç yıkama", "oto", "araç içi"], "🚗"],
  [["şoför"], "🚘"],
  [["bisiklet"], "🚲"],
  [["motosiklet"], "🏍️"],
  [["çekici"], "🚛"],
  [["kaynak"], "⚙️"],
  [["demir", "alüminyum", "pvc", "doğrama"], "🪟"],
  [["mermer", "granit"], "🪨"],
  [["çatı"], "🏠"],
  [["oluk"], "🌧️"],
  [["doğalgaz"], "🔥"],
  [["soğutma"], "❄️"],
  [["etkinlik", "organizasyon", "parti"], "🎉"],
  [["balon"], "🎈"],
  [["doğum günü"], "🎂"],
  [["ses sistemi"], "🔊"],
  [["ışık sistemi"], "💡"],
...
const emojiForSkill = (skill: string, fallback: string): string => {
  const normalized = skill.toLocaleLowerCase("tr-TR");
...
export const SKILL_CATEGORIES: TaskCategoryDefinition[] = SKILL_GROUPS.flatMap((group) =>
  group.skills
    ...
    .map((skill) => ({
      ...
      emoji: emojiForSkill(skill, group.emoji),
      label: skill,
