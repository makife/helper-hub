...
const TERMS: Record<string, string> = {
  ...
  "7. Yaş Sınırı (18+)": "7. Age Requirement (18+)",
  "Bi' El At yalnızca 18 yaşından büyük kullanıcılara açıktır.": "Bi' El At is only available to users over the age of 18.",
  "Kayıt sırasında 18 yaşından büyük olduğunu onaylayan kullanıcı, bu beyanın doğruluğundan bizzat sorumludur.": "A user who confirms during registration that they are over 18 is personally responsible for the accuracy of this statement.",
  "18 yaşından küçük olduğu tespit edilen hesaplar kalıcı olarak kapatılır.": "Accounts found to belong to users under 18 are permanently closed.",
  "8. Değişiklikler ve İletişim": "8. Changes and Contact",
